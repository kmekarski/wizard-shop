    ...
    <form onSubmit={(e) => handleSubmit(e)} className="add-product__form">
      ...
      {props.edit ? (
        <div className="edit-product__buttons">
          <button
            className="btn--medium btn--solid btn add-product__add-btn"
  ...
  return (
    <div className="add-product">
      <div className="container">
        <Header
          title="Admin panel"
          subtitle={props.edit ? "Edit or delete the product" : "Add product"}
          searchbar={false}
          buttons={false}
        ></Header>
        <div className="add-product__main">
          <div className="add-product__left card--big">{leftForm}</div>
          <div className="add-product__right card--big">{rightForm}</div>
        </div>
      </div>
    </div>
  );
