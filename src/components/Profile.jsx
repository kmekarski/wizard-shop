...
export default function Profile(props) {
  ...
  const apiUrl = productsContext.apiAddress;
    ...
    <div className="profile">
      {localStorage.getItem("userID") !== null && (
        <div className="container2">
          ...
          {profileInfo.status === "Unactivated" && (
            <h4 className="text--secondary">Your account is unactivated!</h4>
          )}
          <h4 className="text--secondary">
            {profileInfo.name !== null &&
              profileInfo.surname !== null &&
              "Name: " + profileInfo.name + " " + profileInfo.surname}
          </h4>
          {
            //<h4 className="text--secondary">
